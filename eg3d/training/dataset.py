...
class Dataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        return image.copy(), self.get_label(idx), mask.copy()
...
class ImageFolderDataset(Dataset):
    def __init__(self,
        ...
        **super_kwargs,         # Additional arguments for the Dataset base class.
        ...
        PIL.Image.init()
        self._image_fnames = sorted(fname for fname in self._all_fnames if self._file_ext(fname) in PIL.Image.EXTENSION and "mask" not in fname)
        if len(self._image_fnames) == 0:
            raise IOError('No image files found in the specified path')

        try:
            snap_file = f'{self.camera_sample_mode}_snap_idxs.json' # TODO: get this file
...
if __name__ == '__main__':
    dataset = ImageFolderDataset(path="/home/barthel/Documents/CVG3DGaussianHeads/code/model/eg3d/eg3d/datasets/FFHQ_LPFF", camera_sample_mode="FFHQ")
    print()